...
class Event(SqlAlchemyBase):
    ...
    olymp_code = Column(String, nullable=True)
    olymp = Column(String, nullable=True)
    stage_code = Column(String, nullable=True)
    stage = Column(String, nullable=True)
    english_olymp_code = Column(String, nullable=True)
    english_stage_code = Column(String, nullable=True)
